...
class LaixuatnganhangSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        # In this example, we use XPath to extract the table body
        ...
        # Save the table body data to a JSON file with UTF-8 encoding
        with open('resultBody.txt', 'w', encoding='utf-8') as file:
